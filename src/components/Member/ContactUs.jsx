...
const ContactUs = () => {
  return (
    <div className="bg-white text-gray-800 mt-10">
      {/* Header */}
      <section className="bg-gray-900 text-white text-center py-16 px-4 sm:py-20">
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto flex flex-col md:flex-row gap-12">
        {/* Form */}
        <div className="flex-1 bg-gray-50 rounded-lg shadow-md p-6 sm:p-8">
