              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  ...
                  <ul className="mt-4 space-y-4 text-gray-400">
                    <li><a href="#/join" className="hover:text-white">Plans & Pricing</a></li>
                    <li><a href="#/join" className="hover:text-white">Join Now</a></li>
                    {/* <li><a href="/schedule" className="hover:text-white">Class Schedule</a></li> */}
                    <li><a href="#/contact" className="hover:text-white">Our Locations</a></li>
                  </ul>
                </div>
                <div className="mt-12 md:mt-0">
                  <h3 className="text-sm font-semibold tracking-wider uppercase text-gray-500">Programs</h3>
                  <ul className="mt-4 space-y-4 text-gray-400">
                    <li><a href="#/login" className="hover:text-white">Personal Trainers</a></li>
                    <li><a href="#/login" className="hover:text-white">Workout Plans</a></li>
                    {/* <li><a href="/nutrition" className="hover:text-white">Nutrition</a></li> */}
                    <li><a href="#/about" className="hover:text-white">Success Stories</a></li>
                  </ul>
                </div>
              </div>
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  ...
                  <ul className="mt-4 space-y-4 text-gray-400">
                    ...
                    {/* <li><a href="/join" className="hover:text-white"></a></li> */}
                  </ul>
                </div>
                <div className="mt-12 md:mt-0">
                  <h3 className="text-sm font-semibold tracking-wider uppercase text-gray-500">Users</h3>
                  <ul className="mt-4 space-y-4 text-gray-400">
                    <li><a href="#/login" className="hover:text-white">Trainer Login</a></li>
